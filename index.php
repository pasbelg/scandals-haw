...
<html lang="de">
  ...
  <body>
    ...
    <div id="results">
      <div class="box" id="">
        <h2>Durchschnittliche Dauer eines Skandals im Jahr 2018
        </h2>
        <div id="avgDurVal">
          <?php 
        ...
        <div id="horizontalChart">
          <?php
            ...
            for ($i = 1; $i <= 52; $i++) {
                ...
                echo '<div class="nowarp bars monthlyBars" style="height:'.$barHeight.
                'px;">KW '.$i.
                '</div>';
            }
            echo '<br>';
            for ($i = 1; $i <= 12; $i++) {
                echo '<div class="nowarp month" >'.$months[$i].
                '</div>';
            }
          ?> 
        </div>
    ...
    <div class="box" style="height:30px;">
      <div style="float:left;">
        <a class="nowarp first after" href="https://github.com/pasbelg/scandals-haw">Quellcode</a>
